...
import { BsBoxArrowLeft, BsChevronDown, BsChevronUp, BsClipboardData, BsPersonGear } from "react-icons/bs";
                  ...
                  {({ open }) => (
                        <>
                              ...
                              >
                                    ...
                                    >
                                          <Flex
                                                className="flex-col items-start space-y-4 divide-y divide-gray-400 rounded-tremor-default"
                                                style={{ width: "200px", backgroundColor: "#FFF" }}
                                          >
                                                <Link href={`/settings/details/${currentUser?.id}`} className="w-full">
                                                      <Menu.Item>
                                                            <Flex className="justify-start items-center space-x-4 p-4 hover:bg-blue-50 rounded-tremor-default">
